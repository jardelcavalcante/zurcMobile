 ...
 *
 * gera function
 * @param  {string} formatacao OpÃ§Ã£o para fazer a formataÃ§Ã£o
 * @return {string}            CPF vÃ¡lido e formatado
 *
 * valida function
 * @param  {string} valor      O valor para validaÃ§Ã£o
 * @return {boolean}           True para cpf vÃ¡lido - False para cpf invÃ¡lido.
 *
 * formata function
 * @param  {string} valor      O valor para formataÃ§Ã£o
 * @param  {string} formatacao OpÃ§Ã£o para fazer a formataÃ§Ã£o
 *
 * @return {string}            O CPF formatado ou mensagem com erro da formataÃ§Ã£o.
 */
...
function CPF(){
	...
	function formataCPF(value, formatacao){
		...
		if (! /^[0-9]+$/.test(value)) {
			return 'O valor informado contÃ©m caracteres invÃ¡lidos.';
		}

		if (value.length >= 11 ) {
			return 'O valor informado contÃ©m erro. EstÃ¡ passando dÃ­gitos.';
		}else if(value.length <= 11){
			return 'O valor informado contÃ©m erro. EstÃ¡ faltando dÃ­gitos.';
